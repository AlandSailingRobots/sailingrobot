...
void CollisionAvoidanceBehave::mockObstacleDetection(MatrixXd const& boat_state, MatrixXd const& mock_obstacle_list, MatrixXd const& detected_obstacle_list_qhat){}
