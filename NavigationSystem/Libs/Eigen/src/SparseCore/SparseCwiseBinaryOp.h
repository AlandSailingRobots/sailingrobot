...
class CwiseBinaryOpImpl<BinaryOp, Lhs, Rhs, Sparse>::InnerIterator
   ...
   public:
    ...
    typedef internal::
        sparse_cwise_binary_op_inner_iterator_selector<BinaryOp, Lhs, Rhs, InnerIterator>
            Base;
...
// template<typename T> struct internal::func_is_conjunction<internal::scalar_product_op<T> > { enum
// { ret = true }; };
...
class sparse_cwise_binary_op_inner_iterator_selector<BinaryOp, Lhs, Rhs, Derived, Sparse, Sparse> {
   ...
   public:
    EIGEN_STRONG_INLINE sparse_cwise_binary_op_inner_iterator_selector(const CwiseBinaryXpr& xpr,
                                                                       Index outer)
...
class sparse_cwise_binary_op_inner_iterator_selector<scalar_product_op<T>,
                                                     Lhs,
                                                     Rhs,
                                                     Derived,
                                                     Sparse,
...
class sparse_cwise_binary_op_inner_iterator_selector<scalar_product_op<T>,
   ...
   public:
    ...
    EIGEN_STRONG_INLINE Scalar value() const {
        return m_functor(m_lhsIter.value(), m_rhs.coeff(IsRowMajor ? m_outer : m_lhsIter.index(),
...
class sparse_cwise_binary_op_inner_iterator_selector<scalar_product_op<T>,
   ...
   public:
    ...
    EIGEN_STRONG_INLINE Scalar value() const {
        return m_functor(m_xpr.lhs().coeff(IsRowMajor ? m_outer : m_rhsIter.index(),
...
template <typename Derived>
template <typename OtherDerived>
EIGEN_STRONG_INLINE const typename SparseMatrixBase<Derived>::template CwiseProductDenseReturnType<
    OtherDerived>::Type
