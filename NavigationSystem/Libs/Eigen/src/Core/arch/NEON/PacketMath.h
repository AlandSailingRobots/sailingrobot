...
// arm64 does have the pld instruction. If available, let's trust the __builtin_prefetch built-in
// function which available on LLVM and GCC (at least)
...
// Logical Operations are not supported for float, so we have to reinterpret casts using NEON
// intrinsics
template <>
...
// this PALIGN_NEON business is to work around a bug in LLVM Clang 3.0 causing incorrect compilation
// errors, see bug 347 and this LLVM bug: http://llvm.org/bugs/show_bug.cgi?id=11074
