...
struct traits<CwiseUnaryOp<UnaryOp, XprType>> : traits<XprType> {
    ...
    enum {
        Flags =
            _XprTypeNested::Flags & (HereditaryBits | LinearAccessBit | AlignedBit |
...
class CwiseUnaryOp
   ...
   public:
    typedef typename CwiseUnaryOpImpl<UnaryOp,
                                      XprType,
    ...
    /** \returns the nested expression */
    typename internal::remove_all<typename XprType::Nested>::type& nestedExpression() {
