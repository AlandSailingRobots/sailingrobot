 ...
 *  \param _OuterStrideAtCompileTime the outer stride, or Dynamic if you want to specify it at
 * runtime. \param _InnerStrideAtCompileTime the inner stride, or Dynamic if you want to specify it
 * at runtime.
 *
 * Here is an example:
