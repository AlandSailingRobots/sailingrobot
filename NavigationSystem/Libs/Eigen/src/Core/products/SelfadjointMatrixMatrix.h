...
struct product_selfadjoint_matrix<Scalar,
    ...
    static EIGEN_STRONG_INLINE void run(Index rows,
        ...
        product_selfadjoint_matrix<
            ...
            ColMajor>::run(cols, rows, rhs, rhsStride, lhs, lhsStride, res, resStride, alpha);
    }
};
...
EIGEN_DONT_INLINE void product_selfadjoint_matrix<Scalar,
    ...
    gemm_pack_lhs<Scalar, Index, Traits::mr, Traits::LhsProgress,
...
struct traits<SelfadjointProductMatrix<Lhs, LhsMode, false, Rhs, RhsMode, false>>
    : traits<ProductBase<SelfadjointProductMatrix<Lhs, LhsMode, false, Rhs, RhsMode, false>,
                         Lhs,
                         Rhs>> {};
}  // namespace internal
...
struct SelfadjointProductMatrix<Lhs, LhsMode, false, Rhs, RhsMode, false>
    : public ProductBase<SelfadjointProductMatrix<Lhs, LhsMode, false, Rhs, RhsMode, false>,
                         Lhs,
                         Rhs> {
