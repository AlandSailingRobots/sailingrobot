...
class IterativeSolverBase : internal::noncopyable {
   ...
   public:
    ...
    /** Default constructor. */
    IterativeSolverBase() : mp_matrix(0) { init(); }
    ...
    /** Initializes the iterative solver for the sparcity pattern of the matrix \a A for further
     * solving \c Ax=b problems.
     *
    ...
    /** Initializes the iterative solver with the numerical values of the matrix \a A for further
     * solving \c Ax=b problems.
     *
    ...
    inline const internal::solve_retval<Derived, Rhs> solve(const MatrixBase<Rhs>& b) const {
     ...
     */
    template <typename Rhs>
    inline const internal::sparse_solve_retval<IterativeSolverBase, Rhs> solve(
