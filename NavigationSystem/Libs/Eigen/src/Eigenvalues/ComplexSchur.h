...
class ComplexSchur {
   public:
     ...
     * the matrix. It is currently set to 30.
     */
   ...
   private:
    ...
    friend struct internal::complex_schur_reduce_to_hessenberg<MatrixType,
...
template <typename MatrixType>
typename ComplexSchur<MatrixType>::ComplexScalar ComplexSchur<MatrixType>::computeShift(
    Index iu,
    Index iter) {
    using std::abs;
    if (iter == 10 || iter == 20) {
...
template <typename MatrixType>
template <typename HessMatrixType, typename OrthMatrixType>
ComplexSchur<MatrixType>& ComplexSchur<MatrixType>::computeFromHessenberg(
