...
class RealQZ {
   public:
     ...
     *
     * \param [in] size  Positive integer, size of the matrix whose QZ decomposition will be
     * computed.
     *
...
inline void RealQZ<MatrixType>::step(Index f, Index l, Index iter) {
    ...
    if (iter == 10) {
        ...
        const Scalar a11 = m_S.coeff(f + 0, f + 0), a12 = m_S.coeff(f + 0, f + 1),
                     ...
                     b22i = Scalar(1.0) / m_T.coeff(f + 1, f + 1), a87 = m_S.coeff(l - 1, l - 2),
                     a98 = m_S.coeff(l - 0, l - 1), b77i = Scalar(1.0) / m_T.coeff(l - 2, l - 2),
        ...
        y = (a22 / b22 - a11 / b11) - (a21 / b11) * (b12 / b22) - (a88 / b88 - a11 / b11) -
            (a99 / b99 - a11 / b11) + (a98 / b88) * (b89 / b99);
        z = a32 / b22;
    }
...
RealQZ<MatrixType>& RealQZ<MatrixType>::compute(const MatrixType& A_in,
    ...
    eigen_assert(A_in.rows() == dim && A_in.cols() == dim && B_in.rows() == dim &&
                 B_in.cols() == dim && "Need square matrices of the same dimension");
