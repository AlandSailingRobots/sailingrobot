...
class Tridiagonalization {
   public:
    ...
    typedef Matrix<RealScalar, SizeMinusOne, 1, Options & ~RowMajor, MaxSizeMinusOne, 1>
        SubDiagonalType;
    typedef
        typename internal::remove_all<typename MatrixType::RealReturnType>::type MatrixTypeRealView;
    typedef internal::TridiagonalizationMatrixTReturnType<MatrixTypeRealView> MatrixTReturnType;

    typedef
        typename internal::conditional<NumTraits<Scalar>::IsComplex,
                                       typename internal::add_const_on_value_type<typename Diagonal<
                                           const MatrixType>::RealReturnType>::type,
    ...
    typedef typename internal::conditional<
        ...
        const Diagonal<Block<const MatrixType, SizeMinusOne, SizeMinusOne>>>::type
...
Tridiagonalization<MatrixType>::subDiagonal() const {
    ...
    return Block<const MatrixType, SizeMinusOne, SizeMinusOne>(m_matrix, 1, 0, n - 1, n - 1)
        .diagonal();
}
 ...
 *
 * \param[in,out] matA On input the selfadjoint matrix. Only the \b lower triangular part is
 * referenced. On output, the strict upper part is left unchanged, and the lower triangular part
...
struct tridiagonalization_inplace_selector {
    ...
    typedef
        typename Tridiagonalization<MatrixType>::HouseholderSequenceType HouseholderSequenceType;
    typedef typename MatrixType::Index Index;
