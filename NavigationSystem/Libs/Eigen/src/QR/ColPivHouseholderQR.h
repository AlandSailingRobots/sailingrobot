...
class ColPivHouseholderQR {
   ...
   public:
    ...
    inline const internal::solve_retval<ColPivHouseholderQR, Rhs> solve(
     ...
     */
    inline const internal::solve_retval<ColPivHouseholderQR,
...
ColPivHouseholderQR<MatrixType>& ColPivHouseholderQR<MatrixType>::compute(
    ...
    RealScalar threshold_helper =
        m_colSqNorms.maxCoeff() * numext::abs2(NumTraits<Scalar>::epsilon()) / RealScalar(rows);
