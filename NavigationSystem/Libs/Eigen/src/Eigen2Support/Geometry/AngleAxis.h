...
class AngleAxis : public RotationBase<AngleAxis<_Scalar>, 3> {
   ...
   public:
    ...
    inline AngleAxis(Scalar angle, const MatrixBase<Derived>& axis)
    ...
    /** Concatenates two rotations */
    inline Matrix3 operator*(const Matrix3& other) const { return toRotationMatrix() * other; }
    ...
    inline Vector3 operator*(const Vector3& other) const { return toRotationMatrix() * other; }
    ...
    inline typename internal::cast_return_type<AngleAxis, AngleAxis<NewScalarType>>::type cast()
        const {
        return
            typename internal::cast_return_type<AngleAxis, AngleAxis<NewScalarType>>::type(*this);
    }
