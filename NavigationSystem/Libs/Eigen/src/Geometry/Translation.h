...
class Translation {
   ...
   public:
    ...
    /** Constructs and initialize the translation transformation from a vector of translation
     * coefficients */
    ...
    template <typename OtherDerived>
    friend inline AffineTransformType operator*(const EigenBase<OtherDerived>& linear,
                                                const Translation& t) {
