...
class RotationBase {
   ...
   public:
    ...
    EIGEN_STRONG_INLINE typename internal::rotation_base_generic_product_selector<
        Derived,
        OtherDerived,
    ...
    friend inline Transform<Scalar, Dim, Affine> operator*(const DiagonalMatrix<Scalar, Dim>& l,
                                                           const Derived& r) {
    ...
    inline Transform<Scalar, Dim, Mode> operator*(
...
struct rotation_base_generic_product_selector<RotationDerived,
                                              DiagonalMatrix<Scalar, Dim, MaxDim>,
                                              false> {
    typedef Transform<Scalar, Dim, Affine> ReturnType;
    static inline ReturnType run(const RotationDerived& r,
...
static inline const MatrixBase<OtherDerived>& toRotationMatrix(
    ...
    EIGEN_STATIC_ASSERT(
        OtherDerived::RowsAtCompileTime == Dim && OtherDerived::ColsAtCompileTime == Dim,
