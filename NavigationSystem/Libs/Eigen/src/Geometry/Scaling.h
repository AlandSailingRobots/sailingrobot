...
class UniformScaling {
   ...
   public:
    ...
    inline typename internal::plain_matrix_type<Derived>::type operator*(
...
template <typename Derived>
typename MatrixBase<Derived>::ScalarMultipleReturnType MatrixBase<Derived>::operator*(
...
template <typename Scalar>
static inline DiagonalMatrix<Scalar, 3> Scaling(const Scalar& sx,
                                                const Scalar& sy,
                                                const Scalar& sz) {
...
template <typename Scalar>
template <int Dim>
inline Transform<Scalar, Dim, Affine> UniformScaling<Scalar>::operator*(
