...
struct LU_kernel_bmod {
    template <typename BlockScalarVector,
              typename ScalarVector,
              typename IndexVector,
              typename Index>
    static EIGEN_DONT_INLINE void run(const int segsize,
...
EIGEN_DONT_INLINE void LU_kernel_bmod<SegSizeAtCompileTime>::run(const int segsize,
                                                                 BlockScalarVector& dense,
                                                                 ScalarVector& tempv,
                                                                 ScalarVector& lusup,
                                                                 Index& luptr,
...
template <typename BlockScalarVector, typename ScalarVector, typename IndexVector, typename Index>
EIGEN_DONT_INLINE void LU_kernel_bmod<1>::run(const int /*segsize*/,
                                              BlockScalarVector& dense,
                                              ScalarVector& /*tempv*/,
                                              ScalarVector& lusup,
                                              Index& luptr,
