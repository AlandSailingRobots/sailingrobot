...
{
    m_LoopTime = m_db.selectFromIdAsDouble("loop_time", "config_wingsail_control", 1);
    m_MaxCommandAngle = m_db.selectFromIdAsDouble("max_cmd_angle", "config_wingsail_control", 1);
}
