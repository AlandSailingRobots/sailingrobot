...
{
    m_LoopTime = m_db.selectFromAsDouble("loop_time", "config_wingsail_control", 1);
    m_MaxCommandAngle = m_db.selectFromAsDouble("max_cmd_angle", "config_wingsail_control", 1);
}
