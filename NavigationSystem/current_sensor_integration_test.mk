...
# Source files
INTEGRATION_TESTS 	= Tests/IntegrationTests/CurrentSensorIntegrationTest.cpp
...
all: $(CURRENT_SENSOR_INTEGRATION_TEST_EXEC) stats

# Link and build
$(CURRENT_SENSOR_INTEGRATION_TEST_EXEC): $(OBJECTS)
	rm -f $(OBJECT_FILE)
...
stats:$(CURRENT_SENSOR_INTEGRATION_TEST_EXEC)
	@echo Final executable size:
	$(SIZE) $(CURRENT_SENSOR_INTEGRATION_TEST_EXEC)
