...
*
* File:
* 		IntegrationTestVelvet.cpp
*
* Purpose:
         Global Integrationtest for the Velvet
*
* Developer Notes:
*        
*
    ...
    void processMessage(const Message* message) {
        ...
        switch (type) {
            ...
            case MessageType::VelvetActuatorFeedback: {
                const VelvetActuatorFeedbackMsg* actmsg =
                    dynamic_cast<const VelvetActuatorFeedbackMsg*>(message);
...
void sendActuatorCommands() {
    ...
    MessagePtr wingSailMsg = std::make_unique<SailCommandMsg>(wingsailAngle16);
