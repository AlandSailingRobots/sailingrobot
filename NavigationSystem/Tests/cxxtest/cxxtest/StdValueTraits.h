...
class ValueTraits<const CXXTEST_STD(string)> : public StdTraitsBase {
    static bool mb_partial(char ch) { return !!(ch & 0x80); }
    static bool mb_start(char ch) { return (ch & 0xC0) == 0xC0; }
...
template <class Element>
   ...
   public:
    ValueTraits(const CXXTEST_STD(vector) < Element > &v) { dumpRange(*this, v.begin(), v.end()); }
};
...
template <class Element>
   ...
   public:
    ValueTraits(const CXXTEST_STD(list) < Element > &l) { dumpRange(*this, l.begin(), l.end()); }
};
...
template <class Element>
   ...
   public:
    ValueTraits(const CXXTEST_STD(set) < Element > &s) { dumpRange(*this, s.begin(), s.end()); }
};
...
template <class Key, class Value>
   ...
   public:
    ValueTraits(const CXXTEST_STD(map) < Key, Value > &m) { dumpRange(*this, m.begin(), m.end()); }
};
...
template <class Element>
   ...
   public:
    ValueTraits(const CXXTEST_STD(deque) < Element > &d) { dumpRange(*this, d.begin(), d.end()); }
};
