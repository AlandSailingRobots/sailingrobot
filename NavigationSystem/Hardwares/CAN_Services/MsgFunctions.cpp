...
bool ParseFastPkg(CanMsg& msg, N2kMsg& nMsg) { // Taken from the CANBUS repo made by Viktor Måsala
...
bool IsFastPackage(const N2kMsg &nMsg) { // Taken from the CANBUS repo made by Viktor Måsala
	switch(nMsg.PGN) {
