	 ...
	 m_db(dbhandler)
{
	...
	m_BaudRate = m_db.tableColumnInt("config_wind_sensor", "baud_rate");
	m_PortName = m_db.tableColumnText("config_wind_sensor", "port");
}
...
{
	m_LoopTime = m_db.tableColumnDouble("config_wind_sensor", "loop_time", "1");
}
