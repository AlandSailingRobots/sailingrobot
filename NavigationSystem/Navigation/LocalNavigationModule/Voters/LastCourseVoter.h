...
#ifndef NAVIGATIONSYSTEM_LASTCOURSEVOTER_H
#define NAVIGATIONSYSTEM_LASTCOURSEVOTER_H
...
public:
    ...
    ///----------------------------------------------------------------------------------
    LastCourseVoter(int16_t maxVotes, int16_t weight);
    ...
    int lastWinningBearing;
};


#endif //NAVIGATIONSYSTEM_LASTCOURSEVOTER_H
