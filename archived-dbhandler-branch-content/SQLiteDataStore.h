...
struct StoreItem {
    ...
    StoreItem(std::string key, int i) : m_Key(key), m_dataType(DataType::Integer), m_int(i) {}

    StoreItem(std::string key, float i) : m_Key(key), m_dataType(DataType::Float), m_float(i) {}
